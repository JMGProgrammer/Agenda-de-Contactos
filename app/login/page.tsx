...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4 relative overflow-hidden">
      {/* Manchas de gradiente azul */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-blue-600/20 rounded-full blur-3xl" />
        <div className="absolute top-1/3 -right-32 w-80 h-80 bg-blue-500/15 rounded-full blur-3xl" />
        <div className="absolute -bottom-20 left-1/3 w-72 h-72 bg-blue-700/20 rounded-full blur-3xl" />
        <div className="absolute top-10 right-1/3 w-48 h-48 bg-cyan-600/10 rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-1 text-sm">
            Iniciá sesión para acceder a tus contactos
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-11 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
                />
                <button
                  type="button"
